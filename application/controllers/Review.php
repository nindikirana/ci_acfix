...
class Review extends REST_Base
{
    private $general_model = "review_model";
    ...
    public function index_get()
    {
        ...
        if(!empty($this->get('user_id'))){
            ...
            $result = $this->{$this->general_model}->get_review_by_user_id($params);
            ...
            $result = $this->{$this->general_model}->get_review_by_post_id($params);
            $this->output_response['status'] = 'success';
            $this->output_response['message'] = 'success';
            $this->output_response['data'] = $result;
            $this->response($this->output_response, 200);
    ...
    public function add_post(){
        ...
        $data['rating_price']   =$this->input->post('rating_price');
        ...
        $result=$this->db->insert('post_review',$data);
        $this->output_response['status'] = 'success';
        $this->output_response['message'] = 'success';
        $this->output_response['data'] = $result;
        $this->response($this->output_response, 200);
