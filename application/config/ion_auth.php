...
*/
$config['tables']['users']           = 'acs_users';
$config['tables']['groups']          = 'acs_groups';
$config['tables']['users_groups']    = 'acs_users_groups';
$config['tables']['login_attempts']  = 'acs_login_attempts';
